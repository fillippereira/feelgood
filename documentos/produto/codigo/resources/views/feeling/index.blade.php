    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        ...
        <div class="container" style="margin-top:2%">
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">Sentimento
                                ...
                                @foreach ( $feelings as $feeling )
                                    ...
                                    @else
                                        <td>
                                            ...
                                            <button class="btn btn-danger btn-sm"onclick="javascript:window.location.href='Sentimento/remove/'+($($(this).parent().parent().children()[0]).html())"><span class="glyphicon glyphicon-trash">Excluir</span></button>
                                        </td>           
                                    @endif
                                    </tr>
                                @endforeach 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Adicionar Sentimento</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>

      <!-- Modal body -->
      <div class="modal-body">
        <form method="post" action="/feeling/add" enctype="multipart/form-data">
...
<div class="modal" id="modal-update-system">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">Atualizar Sentimento</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>

      <!-- Modal body -->
      <div class="modal-body">
        <form method="post" action="/feeling/update/system" enctype="multipart/form-data">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <div class="form-group">
...
<div class="modal" id="modal-update">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div class="modal-body">
        <form method="post" action="/feeling/update" enctype="multipart/form-data">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <div class="form-group">
                <label for="name">ID: <label>
